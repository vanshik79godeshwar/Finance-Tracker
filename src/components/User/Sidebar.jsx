...
import {
  FaUser, FaQuestionCircle, FaTachometerAlt, FaChartLine, FaChartPie,
  FaFileAlt, FaPuzzlePiece, FaCode, FaCreditCard, FaHome, FaMoneyBillWave, FaPiggyBank, FaDollarSign, FaCalculator, FaComments
} from 'react-icons/fa';
