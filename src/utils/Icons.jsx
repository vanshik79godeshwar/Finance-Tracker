...
// New icons
export const totalIncomeIcon = <i className="fa-solid fa-dollar-sign"></i>;
export const totalExpenseIcon = <i className="fa-solid fa-money-bill-wave"></i>;
export const totalBalanceIcon = <i className="fa-solid fa-piggy-bank"></i>;
