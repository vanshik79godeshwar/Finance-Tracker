...
const CareerOpenings = () => {
    ...
    const fetchJobs = async (keyword = '', department = '') => {
        try {
            ...
            console.log('Jobs fetched successfully:', filteredJobs);
                ...
                {showModal && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-20">
                        <div className="bg-white p-4 rounded-lg shadow-lg w-3/4 md:w-1/2">
                            ...
                            <form id="apply-form" onSubmit={handleSubmit}>
                                <input type="hidden" id="job-id" name="jobId" value={currentJobId} />
                                <h2 className="text-xl text-black mb-4">Apply for Job</h2>
                                <label className="block mb-2">
                                    <span className="text-gray-800">Name:</span>
                                    <input
                                        type="text"
                                        ...
                                        onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                                        required
                                        className="block w-full mt-1 p-2 rounded-md border-black bg-slate-200 text-gray-800"
                                    />
                                </label>
                                <label className="block mb-2">
                                    <span className="text-gray-800">Email:</span>
